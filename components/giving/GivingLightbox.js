...
import GivingLightboxOverlay from './GivingLightboxOverlay';

export default class GivingLightbox extends Component {
    static propTypes = {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {this.props.navigator ? false : <GivingLightboxOverlay {...this.getOverlayProps()} />}
            </View>
        );
    }
}
