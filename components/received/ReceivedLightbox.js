...
import ReceivedLightboxOverlay from "./ReceivedLightboxOverlay";

export default class ReceivedLightbox extends Component {
    static propTypes = {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {this.props.navigator ? false : <ReceivedLightboxOverlay {...this.getOverlayProps()} />}
            </View>
        );
    }
}
