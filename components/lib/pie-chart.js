// this is a modified version that comes with react-native-svg-chart
// it most likely needs that package installed to function because it will pull all the dependencies
    ...
    render() {
        ...
        return (
            <View style={style}>
                ...
                >
                    <Svg width={this.props.width} height={this.props.height} style={{ flex: 1 }}>
